...
- `webapp/` contains the angular front-end
...
**Frontend**
* **Language**: [Typescript](https://developer.mozilla.org/bm/docs/Web/JavaScript)
...
6. Launch the containers using ```docker-compose up``` - you should see messages like "Starting Lytehouse_webapp_1 ... done". You can then navigate to the application in your browser at ```http://localhost:8080```. The back-end API can be found at ```http://localhost:5000``` (note, you won't see anything if you navigate to localhost:5000 in your browser) 
